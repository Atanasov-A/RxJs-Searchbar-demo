...
const onTextChange = (e1)=>{
    const serachedValue = searchbar.value;
    _utils.getJsLibrary(serachedValue).then((response)=>{
        const transformedResponse = response.data.results;
        _utils.displayResults(suggestedResults, transformedResponse);
...
const userInputObs = _rxjs.fromEvent(searchbarRx, "input");
userInputObs.pipe(_rxjs.pluck("target", "value"), _rxjs.debounceTime(1000), _rxjs.distinctUntilChanged(), _rxjs.switchMap((searchedText)=>{
    const url = _utils.API_BASE_URL + _utils.API_QUERY + searchedText;
    return _ajax.ajax(url).pipe(_rxjs.map((res)=>res.response.results
    ), _rxjs.catchError((err)=>{
        return _rxjs.of(error);
    }));
})).subscribe((response)=>{
    _utils.displayResults(suggestedResultsRx, response);
});

},{"rxjs":"eIdcY","rxjs/ajax":"fM3J1","./utils":"lfIdr"}],"eIdcY":[function(require,module,exports) {
...
},{"tslib":"j55WF","../observable/zip":"97KMy","../util/lift":"acAIF","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"fM3J1":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
function fromAjax(config) {
    return new _observable.Observable(function(destination) {
        ...
        if (configuredHeaders) {
            for(var key1 in configuredHeaders)if (configuredHeaders.hasOwnProperty(key1)) headers[key1.toLowerCase()] = configuredHeaders[key1];
        }
        ...
        if ((withCredentials || !remainingConfig.crossDomain) && xsrfCookieName && xsrfHeaderName) {
            var xsrfCookie = (_b1 = (_a1 = document === null || document === void 0 ? void 0 : document.cookie.match(new RegExp("(^|;\\s*)(" + xsrfCookieName + ")=([^;]*)"))) === null || _a1 === void 0 ? void 0 : _a1.pop()) !== null && _b1 !== void 0 ? _b1 : '';
        ...
        for(var key1 in headers)if (headers.hasOwnProperty(key1)) xhr.setRequestHeader(key1, headers[key1]);
...
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "AjaxResponse", ()=>AjaxResponse1
);
var _getXHRResponse = require("./getXHRResponse");
var AjaxResponse1 = function() {
...
},{"./getXHRResponse":"056wj","../util/createErrorClass":"5TWEz","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"lfIdr":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "API_BASE_URL", ()=>API_BASE_URL
);
parcelHelpers.export(exports, "API_QUERY", ()=>API_QUERY
);
parcelHelpers.export(exports, "displayResults", ()=>displayResults
);
parcelHelpers.export(exports, "getJsLibrary", ()=>getJsLibrary
);
var _axios = require("axios");
var _axiosDefault = parcelHelpers.interopDefault(_axios);
const API_BASE_URL = "https://api.cdnjs.com/libraries";
const API_QUERY = "?search=";
const displayResults = (list, results)=>{
    // clear list
    list.innerHTML = "";
...
const getJsLibrary = (name)=>{
    const response = _axiosDefault.default.get(API_BASE_URL + API_QUERY + name);
    return response;
};

},{"@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV","axios":"1IeuP"}],"1IeuP":[function(require,module,exports) {
...
},{}]},["1Mq12","5HwUs"], "5HwUs", "parcelRequire2ada")
